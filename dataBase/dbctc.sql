...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-04-2025 a las 20:21:05
...
INSERT INTO `donacion` (`idDonacion`, `nombreDonante`, `correo`, `estadoDonacion`, `tipo`, `fecha`, `monto`, `descripcion`) VALUES
(1, 'Fundación Patitas Felices', 'contacto@patitasfelices.org', 'Finalizada', 'Monetaria', '2024-01-15', 5000.00, 'Donación para vacunación masiva'),
(2, 'Ricardo Fernández', 'ricardo.fdz@correo.com', 'Finalizada', 'Monetaria', '2024-02-02', 1500.50, 'Apoyo para esterilizaciones'),
(3, 'Anónimo', '', 'Pendiente', 'Monetaria', '2024-04-10', 200.00, 'Donación recurrente mensual'),
(4, 'Mariana Sánchez', 'mariana.s@mail.com', 'Finalizada', 'Monetaria', '2024-03-18', 750.00, 'En memoria de su mascota'),
(5, 'Alimentos HappyDog', 'ventas@happydog.mx', 'Finalizada', 'En especie', '2024-01-25', NULL, '100 kg de croquetas premium'),
(6, 'Clínica Veterinaria Central', 'clinica@vetcentral.com', 'Finalizada', 'En especie', '2024-02-14', NULL, 'Servicios médicos por 3 meses'),
(7, 'PetLovers CDMX', 'donaciones@petlovers.mx', 'Pendiente', 'En especie', '2024-04-22', NULL, '30 camas térmicas'),
(8, 'Ana López García', 'ana.lopez@mail.com', 'Finalizada', 'Voluntariado', '2024-03-05', NULL, '20 horas de limpieza de jaulas'),
(9, 'Universidad Canina', 'voluntarios@uc.edu.mx', 'Finalizada', 'Voluntariado', '2024-04-01', NULL, 'Equipo de 10 estudiantes'),
(10, 'Carlos Martínez', 'carlos.mtz@correo.com', 'Pendiente', 'Voluntariado', '2024-05-01', NULL, 'Transporte de mascotas'),
(11, 'Tienda Mascotín', 'tienda@mascotin.com', 'Finalizada', 'En especie', '2024-03-30', NULL, 'Juguetes y collares'),
(12, 'Dr. Alejandro Pérez', 'dr.perez@vet.com', 'Finalizada', 'Monetaria', '2024-02-28', 3000.00, 'Fondo de emergencias'),
(13, 'Escuela Primaria Sol', 'contacto@escuelasol.edu', 'Finalizada', 'Voluntariado', '2024-04-05', NULL, 'Actividades educativas'),
(14, 'Influencer PetFriend', 'petfriend@influencer.com', 'Pendiente', 'Monetaria', '2024-04-25', 800.00, 'Donación por transmisión en vivo'),
(15, 'Anónimo', '', 'Finalizada', 'Monetaria', '2024-01-10', 100.00, 'Donación express');
...
(1, 2, 'Roberto Jiménez', 'roberto.j@correo.com', 'Tacubaya', 'Localizada', '2024-03-10', 'Gata siamesa con collar azul, asustada cerca de torniquetes'),
(2, NULL, 'Lucía Mendoza', 'lucia.m@mail.com', 'Pino Suárez', 'En proceso', '2024-04-15', 'Perro mestizo café con manchas blancas, buscando comida en andén'),
(3, 4, 'Gerardo Ruiz', NULL, 'Chapultepec', 'Localizada', '2024-02-28', 'Perro atrapado en vias'),
(4, NULL, 'Estación Pantitlán', 'atencion@metro.cdmx', 'Pantitlán', 'En proceso', '2024-04-20', '3 cachorros mestizos en zona de taquillas'),
(5, 6, 'María del Carmen', 'maricarm@correo.com', 'Candelaria', 'Localizada', '2024-01-05', 'Chihuahua con pata lastimada, resguardado en oficinas'),
(6, 14, 'Luis Miguel', 'sol_de_Mexico@gmail.com', 'Autobuses del Norte', 'Descartado', '2024-12-09', 'Confundió una estatua con perro dorado - falso positivo');
